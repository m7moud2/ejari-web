        ...
        child: Column(
          ...
          children: [
            ...
            _buildFaqItem('كيف أقوم بحجز عقار؟',
                'افتح العقار ← احجز الآن ← أكمل المدة والعربون والعقد ← ادفع. الهوية تُرفع مرة واحدة من الملف الشخصي وليس في كل حجز.'),
            _buildFaqItem('كيف أوثق حسابي (KYC)؟',
                'من الملف الشخصي ← توثيق الحساب. التقط وجهي البطاقة والسيلفي مرة واحدة. التوثيق مطلوب قبل أي حجز، ولن يُطلب مجدداً داخل شاشة الحجز.'),
