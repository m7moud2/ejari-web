...
| تحميل APK مباشرة | `https://github.com/m7moud2/ejari-web/releases/download/v1.3.4/ejari-1.3.4.apk` |
...
cp build/app/outputs/flutter-apk/app-release.apk releases/ejari-1.3.4.apk

gh release create v1.3.4 releases/ejari-1.3.4.apk \
...
```bash
curl -sS "https://firestore.googleapis.com/v1.3.4/projects/keyo-elite-1/databases/(default)/documents/public_stats/downloads"
```

## تثبيت APK (عملاء حقيقيون — v1.3.4+)
...
| الملف | الوصف |
|-------|--------|
| `ejari-1.3.4.apk` | أحدث إنتاج — محفظة + إقامة قصيرة + Firebase |
