...
| تحميل APK مباشرة | `https://github.com/m7moud2/ejari-web/releases/download/v1.3.16/ejari-1.3.16.apk` |
...
cp build/app/outputs/flutter-apk/app-release.apk releases/ejari-1.3.16.apk

gh release create v1.3.16 releases/ejari-1.3.16.apk \
...
## تثبيت APK (عملاء حقيقيون — v1.3.16+)
...
| الملف | الوصف |
|-------|--------|
| `ejari-1.3.16.apk` | أحدث إنتاج — محفظة + إقامة قصيرة + Firebase |
