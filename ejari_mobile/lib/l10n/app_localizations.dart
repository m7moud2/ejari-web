...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'smart_design': 'Smart Design & Finishing',
      'smart_design_desc': 'Transform your property to ultra-luxury.',
      'ai_concierge_desc': 'Smart assistant to customize property search.',
      'free_price': 'Free',
    ...
    'ar': {
      ...
      'smart_design': 'تصميم وتشطيب ذكي',
      'smart_design_desc': 'حوّل عقارك العادي إلى عقار ذكي فائق الرفاهية.',
      'ai_concierge_desc': 'مساعد ذكي لتخصيص البحث عن العقارات.',
      'free_price': 'مجانًا',
      'starts_from': 'يبدأ من',
