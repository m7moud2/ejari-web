...
- أزرار «تابع حجزك» أوضح (معاينة قابلة للتنفيذ + إرشاد)
- حالات فارغة في الاستكشاف مع مسح الفلاتر
- مسار الدفع أوضح: عربون → متبقي → تأكيد
- المالك: تحصيل ومعاينات من الرئيسية + بانر أولوية
- إشعارات معاينة → حجز → دفع في وضع العرض
