  ...
  static Future<void> initProperties() async {
    ...
    final List<Map<String, dynamic>> defaults = [
      ...
      },
      {
        ...
        'ownerId': 'admin',
        'type': 'شقق',
        'amenities': ['حمام سباحة', 'جيم', 'مولد كهرباء', 'أمن إلكتروني', 'حديقة'],
        'furnished': false,
        'listingMode': 'rent',
        'status': 'approved',
        'isDemo': true,
      ...
      },
      {
        ...
        'ownerId': 'admin',
        'type': 'فلل',
        'amenities': ['حديقة خاصة', 'أتمتة منزلية', 'جراجين', 'كاميرات'],
        'furnished': true,
        'listingMode': 'rent',
        'status': 'approved',
        'isDemo': true,
      ...
      },
      {
        ...
        'ownerId': 'admin',
        'type': 'مكاتب',
        'amenities': ['إنترنت مدمج', 'تكييف مركزي', 'صالة مؤتمرات', 'كافيتيريا'],
        'furnished': false,
        'listingMode': 'rent',
        'status': 'approved',
        'isDemo': true,
