...
- أحدث إصدار منشور: **1.3.7+22**
  - GitHub Releases: https://github.com/m7moud2/ejari-web/releases/tag/v1.3.7
  - صفحة الترويج: https://m7moud2.github.io/ejari-web/promo/
  - AAB للرفع على Play: `ejari_mobile/releases/ejari-1.3.7.aab`
...
## حالة خطوات الإطلاق (بعد 1.3.7)

| الخطوة | الحالة |
|--------|--------|
| بناء ونشر APK 1.3.7 على GitHub | تم |
| تجهيز AAB 1.3.7+22 موقّع | تم — `releases/ejari-1.3.7.aab` |
...
نسخة جاهزة للرفع: `releases/ejari-1.3.7.aab`
...
| AAB path | `ejari_mobile/releases/ejari-1.3.7.aab` |
...
ملف APK التجريبي مناسب لتجربة العملاء الأوائل وجمع الملاحظات، لكنه ليس مناسبًا للرفع على Google Play إذا كان Debug-signed. استخدم AAB الموقّع بمفتاح الإصدار أعلاه (`releases/ejari-1.3.7.aab`).
